class SnapProductUploader < CarrierWave::Uploader::Base
  ...
  version :also_like do
    cloudinary_transformation width: 250, height: 250, crop: :thumb
  end
